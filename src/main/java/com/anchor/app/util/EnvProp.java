...
public class EnvProp {
	...
	private int recommendationPageSize;
	...
	public void init() throws IOException {
		try {
			...
			// Populate Recommendation Config
			populateRecommendationConfig();
	...
	private void populateRecommendationConfig() {
		String recommendationPageSize = env.getProperty("recommendation.page-size", "50");
		this.recommendationPageSize = Integer.parseInt(recommendationPageSize);
	}
