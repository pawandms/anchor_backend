...
public interface UserRepository extends MongoRepository<User, String> {
     ...
     */
    @Query("{ '_id': ?0 }")
    @Update("{ '$set': { 'firstName': ?1, 'lastName': ?2, 'nickName': ?3, 'mobile': ?4, 'mobileBindTime': ?5, 'email': ?6, 'userName': ?7, 'emailBindTime': ?8, 'userLanguage': ?9, 'modUser': ?10, 'modDate': ?11 } }")
    void updateUserInfo(String userId, String firstName, String lastName, String nickName,
            ...
            Long emailBindTime, com.anchor.app.users.enums.UserLanguageType userLanguage, String modUser, Date modDate);
}
