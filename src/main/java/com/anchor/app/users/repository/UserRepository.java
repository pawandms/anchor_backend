...
public interface UserRepository extends MongoRepository<User, String> {
    ...
    void updatePrivacySettings(String userId, com.anchor.app.users.dto.UserPrivacy privacySettings, String modUser, Date modDate);
    ...
    void updateNotificationSettings(String userId, com.anchor.app.users.dto.UserNotification notificationSettings, String modUser, Date modDate);
    ...
    /**
     * Update user info fields (firstName, lastName, nickName, mobile, email, userName)
     ...
     */
    @Query("{ '_id': ?0 }")
    @Update("{ '$set': { 'firstName': ?1, 'lastName': ?2, 'nickName': ?3, 'mobile': ?4, 'mobileBindTime': ?5, 'email': ?6, 'userName': ?7, 'emailBindTime': ?8, 'modUser': ?9, 'modDate': ?10 } }")
    void updateUserInfo(String userId, String firstName, String lastName, String nickName, 
                       ...
                       Long emailBindTime, String modUser, Date modDate);
}
