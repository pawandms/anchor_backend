...
import com.anchor.app.model.Attachment;
...
import com.anchor.app.service.ContentService;
...
//	private UserAuthRepository userAuthRepository;
	...
	public void persistUser(UserVo request) throws UserServiceException
	{
		...
		try {
			User user = new User();
			user.setUid(helper.getLongSequanceNo(SequenceType.USER));
	...
	public List<OauthClientDetails> getAllClients() throws UserServiceException {
		List<OauthClientDetails> result = null;
		try {
			result = oauthClientDetailsRepository.findAll();
		} catch (Exception e) {
	...
	*/
	...
	public User getUserForUserID(Long userID) throws UserServiceException {
	...
	public void addUpdateUserProfileImage(String reqUserID, Long userID, MultipartFile profileImage) throws UserServiceException {
	...
	public void updateUserProfileType(String reqUserID, Long userID, VisibilityType profileType, Date modDate)
			throws UserServiceException {
	...
	public void updateUserLoginStatus(Long userID) throws UserServiceException {
